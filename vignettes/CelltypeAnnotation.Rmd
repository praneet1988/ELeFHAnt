...
##### CelltypeAnnotation(reference=pbmc, query=mydata, downsample=FALSE, classification.method = "Ensemble", crossvalidationSVM = 10, validatePredictions = TRUE, selectvarfeatures = 2000, ntree = 500, classification.approach = "ClassifyCells")
